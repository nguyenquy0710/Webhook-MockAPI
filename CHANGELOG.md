...
## [1.0.10](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/1.0.9...1.0.10) - 2026-04-16

### Added
- **Change password functionality**: Thêm tính năng đổi mật khẩu với xác thực và giao diện người dùng [`10f28a2`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/10f28a2)
- **Backup and restore API configurations**: Triển khai chức năng sao lưu và khôi phục cấu hình API với hỗ trợ giao diện người dùng [`f81a4b4`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/f81a4b4)
- **Path search in request logs**: Thêm chức năng tìm kiếm theo đường dẫn trên trang nhật ký yêu cầu [`153ec31`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/153ec31)

### Changed
- **Dockerfile**: Tái cấu trúc Dockerfile với build đa giai đoạn, cập nhật tham chiếu hình ảnh trong docker-compose [`4e732e8`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/4e732e8)
- **Enhanced dropdown functionality**: Cải thiện chức năng dropdown với hỗ trợ hover và chuyển động mượt mà trong header [`928d4c4`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/928d4c4)

### Fixed
- **Changelog header formatting**: Sửa định dạng tiêu đề changelog cho phiên bản 1.0.9 [`201b291`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/201b291)

### Documentation
- **Deployment and DevOps specifications**: Thêm tài liệu đặc tả triển khai và DevOps cho WebHookMock [`8d5c22e`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/8d5c22e)

### Maintenance
- **Docker Compose volume mapping**: Thêm ánh xạ volume cho lưu trữ nhật ký bền vững [`5de85fe`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/5de85fe)
- **Updated CI/CD versioning**: Cập nhật .version.txt cho build 1.0.7 [`bfd5491`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/bfd5491)
- **Updated CI/CD versioning**: Cập nhật .version.txt cho build 1.0.6 [`754469c`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/754469c)
- **Updated changelog for v1.0.9**: Cập nhật changelog cho phiên bản 1.0.9 [`50a83f8`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/50a83f8)
- **Updated changelog for v1.0.10**: Cập nhật changelog cho phiên bản 1.0.10 [`831fe8b`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/831fe8b)
- **UI style updates**: Cập nhật giao diện người dùng [`06cf561`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/06cf561)
- **Initial planning**: Bắt đầu lập kế hoạch [`0c5df57`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/0c5df57), [`20c108a`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/20c108a)

## [v--output](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/v1.0.9...v--output)

### Commits

- chore(ci): update .version.txt for build 1.0.6 [`754469c`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/754469cc02dba3dbcb64346aa2fad5f77c8cf60f)

## [1.0.9](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/1.0.8...v1.0.9) - 2025-10-14

### Merged

- Coding [`#26`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/26)
- Add admin request logs feature for viewing user logs from admin panel [`#24`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/24)

### Commits

- update style [`06cf561`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/06cf5613daca49b5817ddbfd543bc5aad3afb5ea)
- tooltips [`6f5ec9e`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/6f5ec9e661f0913da0c3b03a73831e985e580754)
- Add admin request logs feature for viewing user logs [`d4220f0`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/d4220f0ae2176ac1a2f274c608368bb2a379fc36)
- chore: update changelog for release 1.0.8 [`5e398e2`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/5e398e292c735596eb438b8968de0e977c7aa6d4)
- update [`1756ca2`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/1756ca298fe08b91bbd3dae4593693de01db6592)
- update [`7cef715`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/7cef71515dbdaf3c77682f5f5a45f36930daa063)
- Initial plan [`d21369f`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/d21369f785fcf657516bb8bd97364fbb7edf0520)
- chore(ci): update .version.txt for build 1.0.5 [`bbd682c`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/bbd682c29b673e693c2411843a3bac870d65f117)

## [1.0.8](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/1.0.7...1.0.8) - 2025-08-26

### Merged

- 13 admin quản lý user [`#22`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/22)
- Copilot/fix 21cf417e ba6a 41d6 9990 7a9f84d14882 [`#17`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/17)
- Add comprehensive admin user management features (Thêm tính năng admin, quản lý các user) [`#12`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/12)
- [WIP] bị lỗi này, fix giúp tôi [`#16`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/16)
- Add comprehensive database migration system with Flyway for existing users [`#15`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/15)
- Enhance UI with Bootstrap 5.3.3 upgrade and modern styling improvements [`#14`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/14)
- Add admin user management [`#11`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/11)

### Commits

- Refactor styles and update footer/header links for QuyIT Platform [`348820f`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/348820f4571e4c6ef73894c3b3cb82c5063cdd0d)
- Implement comprehensive admin user management features [`c018c93`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/c018c93d1df0f2bc85ed00dc517e33d159a45120)
- Upgrade Bootstrap to 5.3.3 and enhance UI components with modern styling [`2d822a5`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/2d822a5a7d78a9f5f5e67119f35539dbda2938cd)
- Add comprehensive database migration system with Flyway [`95e3ee0`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/95e3ee0516aba76c0f74c7cf4ad2e9b1602e38b5)
- Update application properties, add logging configuration, and enhance Swagger documentation [`5ad77e5`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/5ad77e5aca72bbffbf1228e78d46acf33f706a3a)
- Add ApiConfigController and ApiConfigService for managing API configurations [`83d1579`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/83d1579a249908a9b52195127c8a7deeac8fc6a9)
- Fix Java 25 EA native access warnings and improve Flyway migration robustness [`f98be9d`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/f98be9d9ede05cbac63236985293ec856c7c8506)
- Add enhanced CSS with loading states, improved transitions, and modern footer styling [`69fa763`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/69fa763f02eabce416f47b700dcd252ce91a946b)
- Update .gitignore and README.md; add Java configuration instructions and new cookies.txt file [`c4f1b74`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/c4f1b74c76b82c26e9dd174595fda2f5899f7ceb)
- Refactor request-log.js: improve formatting and add delayed JSON formatting on modal open [`f905c6b`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/f905c6bac834b54aa57d7c6668cc60e561fcc628)
- Update issue templates [`aed23f9`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/aed23f9dbf53d4b5df0f57e4ed3f63855a308757)
- Add migration script for delay_ms column and user role enhancements [`7c6662f`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/7c6662fd5bcee6e50831e5df4b0b3ab398097cb4)
- Remove AdminControllerTest class and associated test cases [`2a218f7`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/2a218f7f7d1a3340af4d12a94af74485af4932bb)
- Update Dockerfile [`aba8804`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/aba8804de1bba373ffc397796535eea1e8223351)
- Create .dockerignore [`89d4add`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/89d4addb2831a4e9fc4c3f00ba8af376fd9a0881)
- Add Flyway CLI installation and entrypoint script for database migrations [`ea8a8f3`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/ea8a8f35961736ff7311b0330895c0f05a27a166)
- chore: update changelog for release 1.0.7 [`25877fe`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/25877fe0cb1bee12de09e0491f3d33f059e5e343)
- Update README and migration scripts: enable Flyway migrations and add conditional column addition [`8d1903f`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/8d1903f2c337a62167d4caec741ec5b70544845a)
- update user menu [`26954c8`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/26954c8d13290c6f5007450ed93d5975a8799e11)
- Remove delay_ms column addition from migration scripts and retain user role and enabled column updates [`3824f2f`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/3824f2fb7a19957d2d4a48efee78884db1ecae74)
- Update docker-compose.yml [`1ef649d`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/1ef649dba4e3cf165dd4011fc21d3bdd147e7d64)
- Update README.md [`b14be13`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/b14be1317dc25be0c3295b7c35483662e3e2fb9f)
- Refactor AdminController: reorganize imports and enhance code readability [`3d395a6`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/3d395a678576fa275d692181efa6f529e6a0c728)
- Refactor Dockerfile: Remove Flyway CLI installation and simplify JAVA_TOOL_OPTIONS [`3365c35`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/3365c35af5e7e2a4e03eac4741c1fc145aac28d1)
- Enhance database migration process: add automatic migration after repair and ensure database is up-to-date [`db91420`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/db9142017ecf9bcb41daccd0cc11326fa3eb7939)
- Add Java runtime configuration to settings.json [`b2bdeba`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/b2bdeba47b35da780c1acf89bf290afe699a514b)
- Enhance AdminController: include username in user listing, detail, and creation views [`ef2522f`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/ef2522f800c1fa7d6052046afb0184c1029b0c23)
- ⚡ Add SECURITY.md file [`d9faaab`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/d9faaabfd38fd68b40ca1ab3f5d8fe58daf23362)
- Add user role and enabled columns to users table; update migration scripts for data consistency [`a4bb6ef`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/a4bb6ef3535bb826484bcfc2a99e9b960bd27de3)
- Update .gitignore to exclude JAR files and database directory [`787b061`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/787b061f305737bf586def5555692924b2ecffb3)
- Update api-config-edit.html [`ebe969e`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/ebe969e81c5340df02ff52ca244dc953437aef45)
- Update Dockerfile [`d749668`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/d749668b22eaaba0d09da2f195cb7863dd14192d)
- Update User entity: change role and enabled columns to nullable with default values [`10a94cc`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/10a94cca54873edd86d919d4539ff740593aca4d)
- Update api-config.html [`bda1bac`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/bda1bac994ce6e38a6934fba1dba47c794e4ebda)
- Update README.md [`f63c66c`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/f63c66c9a7a7029de0ba171897c5b03a77fc91b9)
- Uncomment Hibernate ddl-auto update setting to enable automatic column addition [`44ba49c`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/44ba49c6aefd996116b7aaa50dfaa8dddd152ec4)
- Update api-config.html [`2f5d6f6`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/2f5d6f66e80fce386230183c730e61c17d396670)
- Update workspace settings: add Java build configuration update setting [`d9d3d49`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/d9d3d493fc40899699c4f3c6b26e5b5882f2b1f7)
- Disable Flyway migrations in application properties [`59a7bc9`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/59a7bc9695dbe61c08dedc4616b7f3112569dc91)
- Enable H2 console access for external connections [`e941e7a`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/e941e7ad481a90984bd6546cebe23f57ac4de206)
- Add migration script for role and enabled columns in users table [`d938ed6`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/d938ed6aa02aad53d7f47a7f3642b7deb6560169)
- Initial plan [`7968d0a`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/7968d0a05aa7c362541aa2dec712e7a876e29433)
- Initial plan [`ade719a`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/ade719ad46c4902fa5dd7ff536e2a3ede13fc6e9)
- Initial plan [`7fa491d`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/7fa491da1d518f8bf08664dd7435d8c268c2decb)
- Initial plan [`dc369e9`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/dc369e9e848c694ed985d7efaedea1be93d0aaec)
- Update Dockerfile [`72a274c`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/72a274cb1bae95d2b78289de10275a09938a6d68)
- Update docker-compose.yml [`06258fa`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/06258fa94ae28fc33e7fd71fc9c413f0574db323)
- chore(ci): update .version.txt for build 1.0.4 [`5aa9861`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/5aa98616d6ad5f0e7f6bdbf0515efb2d17c44f75)

## [1.0.7](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/1.0.6...1.0.7) - 2025-07-09

### Merged

- Add per-user Swagger generation [`#8`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/8)

### Commits

- Remove custom Swagger theme [`ed9d1d8`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/ed9d1d89a97931b68e813ef29259ed188e43b7c2)
- Add custom Swagger UI theme [`e789b96`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/e789b96bf182be90ee1b4f732d4cc9cbae2b12b9)
- chore: update changelog for release 1.0.6 [`cca3c90`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/cca3c9017a3f63fbf65802613628f0eba313c6bf)
- Update ci-cd.yml [`164a727`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/164a727503994c77253f97fc5c6e6b47f905af5c)
- docs: align swagger ui bullet [`eb17c57`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/eb17c570359b62ef6cc87fc4cb8373090b9ab1f9)
- Fix swagger-ui URL expression [`ec147ab`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/ec147ab9caa4acc76b4ecf974dd9ab31420718f9)
- comment write exception [`04ddeed`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/04ddeedb2e16902dde31673e8a6464d5c6f82587)
