...
## [--output](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/1.0.10...--output)

### Commits

- chore(ci): update .version.txt for build 1.0.7 [`bfd5491`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/bfd549127616ff270c92ee92473e6dff95b8ac8c)

## [1.0.10](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/v1.0.9...1.0.10) - 2026-04-16

### Merged

- Coding [`#32`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/32)
- Coding [`#31`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/31)
- Add path search filter to Request Logs page [`#29`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/29)
- 13 admin quản lý user [`#30`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/30)
- main -&gt; coding [`#28`](https://github.com/nguyenquy0710/Webhook-MockAPI/pull/28)

### Commits

- Add change password functionality with validation and UI integration [`10f28a2`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/10f28a2e604ea34b297cf7d59f48980a75b03e7f)
- Implement backup and restore functionality for API configurations with UI support [`f81a4b4`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/f81a4b4ec1570605ceb7afa0ff0eaf3c0f53dfef)
- init cli ai [`20c108a`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/20c108a3eafec352967c50c1a3f4cff9b15bc3d1)
- Add path search functionality to Request Logs page [`153ec31`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/153ec3135e42f61c8b510b101dacc9627276cdc6)
- Refactor Dockerfile for multi-stage build, update image references in docker-compose, and enhance logout functionality in AuthController [`4e732e8`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/4e732e81af76a5d060a8fb9426fcef2be4ac3c10)
- Enhance dropdown functionality with hover support and smooth transitions in header [`928d4c4`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/928d4c4a137786577b1b7cfc0737ad50ab62decc)
- chore: update changelog for release v1.0.9 [`50a83f8`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/50a83f8eb662973792952cf8b063027951712410)
...
- Add volume mapping for persistent log storage in Docker Compose [`5de85fe`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/5de85fed428b263ed23aba6ab8016fef364f5142)
- Initial plan [`0c5df57`](https://github.com/nguyenquy0710/Webhook-MockAPI/commit/0c5df578222cc94ff412ebffc9feeaec83b5cd94)

## [v1.0.9](https://github.com/nguyenquy0710/Webhook-MockAPI/compare/1.0.8...v1.0.9) - 2025-10-14
